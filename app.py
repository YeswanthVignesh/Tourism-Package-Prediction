...
with col2:
    ...
    number_of_trips = st.number_input("Number of Trips (Annually)", min_value=0, max_value=20, value=1)
...
with col3:
    ...
    monthly_income = st.number_input("Monthly Income", min_value=5000, max_value=100000, value=25000)
...
with col4:
    ...
    product_pitched = st.selectbox("Product Pitched", options=["Deluxe", "Basic", "Standard", "Super Deluxe", "King"], index=0)
